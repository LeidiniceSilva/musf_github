            ...
            for i in c.itermonthdays(year, mon):
                ...
                if i != 0:
                    ...
                    if day.weekday() == calendar.MONDAY:
                        ...
                        ons_new = np.concatenate((ons1, ons2), axis=0)
...
wb = xlsxwriter.Workbook('methods_classification_daily_multicriteria_distance.xlsx')
...
file_name = '{0}best_dmcr_all_basins.asc'.format(dir_file)
