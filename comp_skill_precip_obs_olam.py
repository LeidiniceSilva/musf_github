...
""" Compute real precipitation of olamv.3.3 model and obs.
...
link = home + "/Documentos/sic_2017/codes"

arq1 = '{0}/precip_controle_1982_2012_{1}_{2}_neb_new_REAL_ok_full_negcor_monsum_noocean.nc'.format(link, paramet, grad)
data1 = netCDF4.Dataset(arq1)
variable1 = data1.variables['precip'][:]
lat = data1.variables['lat'][:]
lon = data1.variables['lon'][:]

arq2 = '{0}/pr_Amon_CRU-TS3.22_observation_198201-201212_new_mmm_neb.nc'.format(link)
...
#
# plt.title(u'Climatologia Anual de Precipitação \n OLAMv.3.3_{0}_{1} x OBS - 1982_2012'
#           .format(grad, paramet.upper()), fontsize=34, fontweight='bold')
